...
import org.jivesoftware.smackx.packet.OobExtension;
...
public class MultiUserChat {
    ...
    public void sendMessage(String text, String oobUrl) throws XMPPException {
        Message message = new Message(room, Message.Type.groupchat);
        if (oobUrl != null) message.addExtension(new OobExtension(oobUrl));
    ...
    */
            ...
            public void processPacket(Packet packet) {
                ...
                if (presence.getType() == Presence.Type.available) {
                    ...
                    if (oldPresence != null) {
                        ...
                        boolean isRoleModification = checkRoleModifications(oldRole, newRole, isUserStatusModification, from, presence);
                        if (!isRoleModification) 
                        	isAffiliationModification = checkAffiliationModifications(oldAffiliation, newAffiliation, isUserStatusModification, from, presence);
                        
                        if (!isRoleModification && !isAffiliationModification) {
                        	List<String> params = new ArrayList<String>();
                            params.add(from);
                            params.add(presence.getPacketID());
     ...
     */
    private boolean checkRoleModifications(String oldRole, String newRole, boolean isUserModification, String from, Presence presence) {
     ...
     * (e.g. room@conference.jabber.org/nick).
     */
    private boolean checkAffiliationModifications(String oldAffiliation, String newAffiliation, boolean isUserModification, String from, Presence presence) {
     ...
     * @param from
     */
    private void checkPresenceCode(String code, boolean isUserModification, MUCUser mucUser, String from, Presence presence) {
