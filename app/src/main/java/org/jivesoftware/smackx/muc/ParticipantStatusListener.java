...
public interface ParticipantStatusListener {
	 ...
	 */
	public abstract void statusChanged(String participant, String id);
     ...
     */
    public abstract void joined(String participant, String id);
     ...
     * (e.g. room@conference.jabber.org/nick).
     */
    public abstract void left(String participant, String id);
     ...
     */
    public abstract void kicked(String participant, String actor, String reason, String id);
     ...
     * (e.g. room@conference.jabber.org/nick).
     */
    public abstract void voiceGranted(String participant, String id);
     ...
     * (e.g. room@conference.jabber.org/nick).
     */
    public abstract void voiceRevoked(String participant, String id);
     ...
     */
    public abstract void banned(String participant, String actor, String reason, String id);
     ...
     * (e.g. room@conference.jabber.org/nick).
     */
    public abstract void membershipGranted(String participant, String id);
     ...
     * (e.g. room@conference.jabber.org/nick).
     */
    public abstract void membershipRevoked(String participant, String id);
     ...
     * (e.g. room@conference.jabber.org/nick).
     */
    public abstract void moderatorGranted(String participant, String id);
     ...
     * (e.g. room@conference.jabber.org/nick).
     */
    public abstract void moderatorRevoked(String participant, String id);
     ...
     * (e.g. room@conference.jabber.org/nick).
     */
    public abstract void ownershipGranted(String participant, String id);
     ...
     * (e.g. room@conference.jabber.org/nick).
     */
    public abstract void ownershipRevoked(String participant, String id);
     ...
     * (e.g. room@conference.jabber.org/nick).
     */
    public abstract void adminGranted(String participant, String id);
     ...
     * (e.g. room@conference.jabber.org/nick).
     */
    public abstract void adminRevoked(String participant, String id);
     ...
     */
    public abstract void nicknameChanged(String participant, String newNickname, String id);
