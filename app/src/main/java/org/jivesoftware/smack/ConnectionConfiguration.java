...
public class ConnectionConfiguration implements Cloneable {
    ...
    private int smMax = 300;
    private boolean smResume = false;
    private int smInH = 0;
    private String smPrevId = null;
    ...
    public void setSmMax(int max) {
        this.smMax = max;
    }

    public boolean isSmResume() {
        return smResume;
    }

    public void setSmResume(boolean smResume) {
        this.smResume = smResume;
    }

    public void setSmInH(int h) {
        this.smInH = h;
    }
    ...
    public void setSmPrevId(String id) {
        this.smPrevId = id;
    }

    public String getSmPrevId() {
        return smPrevId;
    }
}
