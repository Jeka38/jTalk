        ...
        try {
            ...
            do {
                if (eventType == XmlPullParser.START_TAG) {
                    if (parser.getName().equals("message")) {
                    ...
                    else if (parser.getName().equals("failed")) {
                        parser.next();
                    }
                        ...
                        processPacket(PacketParserUtils.parseEnabled(parser));
                    } else if (parser.getName().equals("enable")) {
                        processPacket(PacketParserUtils.parseEnable(parser));
                    }  else if (parser.getName().equals("resume")) {
                        processPacket(PacketParserUtils.parseResume(parser));
                    } else if (parser.getName().equals("resumed")) {
                        processPacket(PacketParserUtils.parseResumed(parser));
                    } else if (parser.getName().equals("a")) {
                        processPacket(PacketParserUtils.parseA(parser));
                    } else if (parser.getName().equals("r")) {
                        processPacket(PacketParserUtils.parseR(parser));
                    }
