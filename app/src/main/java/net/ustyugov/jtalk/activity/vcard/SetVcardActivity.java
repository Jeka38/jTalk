...
public class SetVcardActivity extends Activity implements OnClickListener {
	...
	public void publish() {
		Toast.makeText(SetVcardActivity.this, getString(R.string.PleaseWait), Toast.LENGTH_LONG).show();
		finish();
  		new Thread() {
  			public void run() {
  				try {
   ...
   protected void onActivityResult(int requestCode, int resultCode, Intent data) {
    ...
    private void setScaledBitmap(byte[] bytes) {
        Bitmap bitmap = null;
        ...
        if (bitmap != null) {
            ...
            if (width > maxWidth)  {
                ...
                bitmap = Bitmap.createScaledBitmap(bitmap, (int) (width * SetVcardActivity.this.getResources().getDisplayMetrics().density), (int) (bitmap.getHeight() * SetVcardActivity.this.getResources().getDisplayMetrics().density), true);
            }
