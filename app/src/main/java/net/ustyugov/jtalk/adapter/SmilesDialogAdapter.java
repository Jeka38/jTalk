...
public class SmilesDialogAdapter extends ArrayAdapter<String>{
	...
	private LinkedHashMap<String,String> hash;
    private int size = 18;
	
	public SmilesDialogAdapter(Context context, LinkedHashMap<String,String> hash, LinkedHashMap<String, List<String>> table) {
